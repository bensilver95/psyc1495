...
When we get a new dataset, the first thing we want to do, before looking at relationships between variables, is understand the structure of our data. We want to be able to *describe* it before we can make *inferences* about it.
